        ...
        <div className="row align-item-center">
          ...
          <img src="./images/arrow.png" alt="" className="img-fluid" style={{width:"100px"}}/>
            ...
            <div className="d-flex align-items-center">
              ...
              <div><p style={{color:'#CCCCC',fontSize:'12px',marginBottom:'-5px'}}>Deliver to</p>
          ...
          <div className="col-md-2">
            ...
            <li className="list-unstyled"><Link to="#" className="text-decoration-none px-2 custom-link"><i className='bx bx-user' ></i></Link></li>
            <li className="list-unstyled"><Link to="#" className="text-decoration-none px-2 custom-link"><i className='bx bx-user-plus'></i></Link></li>
